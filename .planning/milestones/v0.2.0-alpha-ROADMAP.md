...
- [x] **Phase 6: shieldDash lane** - The travelling-hitbox lane gap-closer — the hardest shape, done last. (completed 2026-07-13; capstone playtest approved by user, seed deviations leapSlam maxBand 5.5 + size-2 laneLength 7.95 accepted)
- [→] **Phase 7: Crit poise interrupt** - DEFERRED to a later milestone at v0.2.0-alpha close (2026-07-13). Spec: `.planning/todos/pending/2026-07-13-phase-7-crit-poise-interrupt-DEFERRED.md`
...
- [x] 04-07-PLAN.md — verification capstone: local migrated-DB playtest (human) approved 2026-07-13; maincloud steps obsolete after self-host pivot (SC5 carried to prod-deploy gate)
...
- [x] 06-05-PLAN.md — capstone: human playtest approved 2026-07-13 (SC1/SC2/SC3); deviation rulings ACCEPTED by user (leapSlam maxBand 8→5.5, size-2 laneLength 7.95)
...
| 7. Crit poise interrupt | — | Deferred (todo) | - |
