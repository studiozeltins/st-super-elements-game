...
- [x] **STCK-01**: Water Pro v3.2.1 + Sky Pro v2.0.0 are vendored into `src/vendor/` (prebuilt
...
- [x] **STCK-03**: A git policy for `src/vendor/**` (licensed bundles) is decided and applied so
