...
number: 1
name: Windless/lull flag droop (Gap 1, 08-10)
expected: |
  During normal play the camp flag DROOPS between gusts (limp-ish hang, not a near-horizontal banner) and LIFTS toward taut/streaming when a gust travels through, then sags back as the gust passes. Under ?nowind the flag hangs FULL limp down the pole.
