...
- [ ] 03-01-PLAN.md — Pure `applyDeathShardPenalty` helper + cross-import unit test (Nyquist Wave 0)
- [ ] 03-02-PLAN.md — Server: `shard_drop` table + `spillShards` + `collectShard`, wire penalty into 3 death paths (keep gem spill, PVP credits `shardsLost`)
