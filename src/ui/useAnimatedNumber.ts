...
// over quickly, a raid payout rolls long enough to feel earned.
const MIN_DURATION_MS = 600;
const MAX_DURATION_MS = 1400;
/** Deltas at/above this magnitude get the full roll. */
const FULL_ROLL_DELTA = 500;
/**
 ...
 * changes up to 1.4s for 500+), rounding to integers and settling EXACTLY on
 * target. No rAF runs while the value is idle; a target change mid-roll
