// VERBATIM client mirror of spacetimedb/src/steering.ts (the server is the
// source of truth — edit both together). Movement is server-authoritative; the
// client keeps this mirror so rendering/prediction code can reason about the
// same avoidance geometry. steering.test.ts parity-locks the two files.
//
